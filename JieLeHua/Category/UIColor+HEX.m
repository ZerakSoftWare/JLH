...
+ (UIColor *)globalThemeColor {
    return [UIColor colorWithRed:13.0/255.0 green:136.0/255.0 blue:255.0/255.0 alpha:1.0f];
}

+ (UIColor *)unableButtonThemeColor {
    return [UIColor colorWithRed:166.0/255.0 green:196.0/255.0 blue:244.0/255.0 alpha:1.0f];
}
@end
