...
static HDMessageReadManager *detailInstance = nil;

@interface HDMessageReadManager()
                      ...
                      updateViewCompletion:(void (^)(HDMessageModel *prevAudioModel, HDMessageModel *currentAudioModel))updateCompletion
{
    ...
    {
        HDMessageModel *prevAudioModel = self.audioMessageModel;
        HDMessageModel *currentAudioModel = messageModel;
