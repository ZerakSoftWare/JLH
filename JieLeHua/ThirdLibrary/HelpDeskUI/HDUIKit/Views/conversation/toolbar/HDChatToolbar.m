...
//    _inputTextView.layer.cornerRadius = 6.0f;
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"icon_chat_Voice"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"icon_chat_keyboard"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"icon_chat_Expression"] forState:UIControlStateNormal];
//    [self.faceButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_faceSelected"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"icon_chat_keyboard"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"icon_chat_plus"] forState:UIControlStateNormal];
//    [self.moreButton setImage:[UIImage imageNamed:@"HelpDeskUIResource.bundle/chatBar_moreSelected"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"icon_chat_reduce"] forState:UIControlStateSelected];
