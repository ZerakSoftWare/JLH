...
- (void)setupSubviewsForType:(HDChatToolbarType)type
{
    ...
    [_photoButton setImage:[UIImage imageNamed:@"icon_chat_image_normal"] forState:UIControlStateNormal];
    [_photoButton setImage:[UIImage imageNamed:@"icon_chat_image_pressed"] forState:UIControlStateHighlighted];
    ...
    [_takePicButton setImage:[UIImage imageNamed:@"icon_chat_takepic_normal"] forState:UIControlStateNormal];
    [_takePicButton setImage:[UIImage imageNamed:@"icon_chat_takepic_pressed"] forState:UIControlStateHighlighted];
    ...
    [_leaveMessageButton setFrame:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2, 10, CHAT_BUTTON_SIZE , CHAT_BUTTON_SIZE)];
    [_leaveMessageButton setImage:[UIImage imageNamed:@"icon_chat_message_normal"] forState:UIControlStateNormal];
    [_leaveMessageButton setImage:[UIImage imageNamed:@"icon_chat_message_pressed"] forState:UIControlStateHighlighted];
...
//    [_scrollview addSubview:_leaveMessageButton];
    ...
    _leaveMessageLabel = [[UILabel alloc] initWithFrame:CGRectMake(insets * 3 + CHAT_BUTTON_SIZE * 2, 10 + CHAT_BUTTON_SIZE, CHAT_LABEL_SIZE_WIDTH , CHAT_LABEL_SIZE_HEIGHT)];
